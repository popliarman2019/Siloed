public class Main {
	...
	// write your code here
        ...
        float gallonsPPPD = ((tWater / 37640.0f) * (65.0f / 0.246f)) / 28;
        float waterSave = 65.0f - gallonsPPPD;

        System.out.printf("Each person in town needs to save %.2f gallons.",waterSave);
        System.out.println();
